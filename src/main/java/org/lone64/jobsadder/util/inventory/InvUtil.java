package org.lone64.jobsadder.util.inventory;
...
public class InvUtil {
    ...
    public InvUtil(Player player, String title, int slot) {
        this.player = player;
        this.inventory = Bukkit.createInventory(null, slot, Util.replaceLegacyColor(title));
    }

    public InvUtil(Player player, String title, InventoryType type) {
        this.player = player;
        this.inventory = Bukkit.createInventory(null, type, Util.replaceLegacyColor(title));
    }
